...
/**
 * Backbone of the emotion recognition system. Communicates with sensor
 * listeners and data manager, uses feature extractors and emotion classifiers
 *
 */
public class EmotionEngine implements SensorObserver, SensorFactory, DataManagerObserver {
    ...
    /**
     * registered observers which are to be notified when a sensor connection
     * status is changed
     */
        ...
        synchronized (executorLocker) {
            executorService.submit(new Callable<Void>() {
                ...
                public Void call() throws Exception {
                    ...
                    for (SensorListener listener : pendingSensorListeners) {
